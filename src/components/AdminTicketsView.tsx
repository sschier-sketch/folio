          ...
          <>
                              ...
                              {att.type?.startsWith("image/") ? (
                                <div className="mt-1">
                                  <img
                                    ...
                                    style={{ maxHeight: 200 }}
                                  />
                                  <p className={`text-xs mt-1 ${msg.sender_type === "admin" ? "text-white/70" : "text-gray-400"}`}>
                                    {att.filename}
                                  </p>
                                </div>
                              ) : (
                                ...
                                >
                                  ...
                                  {att.filename}
                                  <span className={msg.sender_type === "admin" ? "text-white/50" : "text-gray-400"}>
            ...
            {selectedTicket.status !== "closed" && (
              <div className="px-6 py-4 border-t">
                ...
                />
                {signature && (
                  <div className="px-3 py-2 bg-gray-50 border border-t-0 border-gray-200 rounded-b-lg">
                ...
                {attachments.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-2">
                    {attachments.map((file, idx) => (
                      <div
                        key={idx}
                        className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-xs text-gray-600"
                      >
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-gray-500 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-40"
                      title="Dateien anhängen (max. 10)"
                    >
                    ...
                    >
                      {sending ? (
                        ...
                        <>Antworten{attachments.length > 0 && ` (${attachments.length})`}</>
                      )}
                    </Button>
                  </div>
                </div>
