  ...
  return (
    <div>
      ...
      <div className="space-y-8">
        <div>
          <h4 className="text-lg font-semibold text-dark mb-4">Vergleichsmiete &amp; Begründung</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-dark mb-4">Vorherige Mieterhöhungen</h4>
          <div className="space-y-5">
            <RadioToggle
