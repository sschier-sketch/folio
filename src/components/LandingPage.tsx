          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 pt-8">
              ...
              <h1 className="text-5xl sm:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                ...
                <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">neu gedacht</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-lg rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center gap-2"
                >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-8 mb-20 text-white shadow-2xl">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold mb-3">Transparente Preise</h2>
                <p className="text-blue-100">Starten Sie kostenlos und upgraden Sie bei Bedarf</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl p-6 text-slate-900 shadow-xl border-4 border-amber-400 relative overflow-hidden">
                  <div className="absolute top-0 right-0 bg-amber-400 text-slate-900 px-4 py-1 text-xs font-bold rounded-bl-lg">
                    BELIEBT
                  </div>
                  <div className="flex items-center gap-2 mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-slate-100">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Objektverwaltung</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-slate-100">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Mieterverwaltung</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-slate-100">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Ticketsystem</h3>
                <p className="text-slate-600">
            ...
            <div className="bg-white rounded-3xl p-12 shadow-xl border border-slate-100 mb-20">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900">Renditeberechnung</h4>
                        <p className="text-slate-600">Automatische Berechnung der Objektrendite basierend auf Mieteinnahmen und Kosten</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900">Automatische Mieterhöhungs-Erinnerungen</h4>
                        <p className="text-slate-600">Werden Sie 3 Monate vor Index- und Staffelmiete-Erhöhungen automatisch per Ticket erinnert</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900">Mieter-Kommunikation</h4>
                        <p className="text-slate-600">Integriertes Ticketsystem für professionelle Kommunikation mit Ihren Mietern</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900">Kreditverwaltung</h4>
                        <p className="text-slate-600">Behalten Sie den Überblick über Ihre Finanzierungen und Kreditkosten</p>
                      </div>
                    </div>
                  </div>
                </div>
