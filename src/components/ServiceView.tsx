  ...
  return (
    <div>
      ...
      <a
        ...
        className="flex items-center gap-4 p-5 bg-white rounded-lg mb-8 group hover:shadow-sm transition-all"
      >
        ...
        <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-blue-500 shrink-0 transition-colors" />
      </a>
