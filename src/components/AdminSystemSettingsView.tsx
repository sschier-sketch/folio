        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t">
            ...
            <button
              onClick={handleSave}
              disabled={!canSave}
              className="px-6 py-2 text-sm font-medium text-white bg-primary-blue rounded-lg hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {saving ? (
                <>
