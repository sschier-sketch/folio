      ...
      const data = {
        ...
        index_first_increase_date:
          formData.rent_increase_type === "index"
            ? formData.index_first_increase_date
            : null,
              ...
              <div className="col-span-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="flex-1 cursor-pointer">
                    {" "}
                    <div className="flex items-center gap-2 px-4 py-2 border-2 border-dashed rounded-lg hover:border-blue-400 transition-colors">
                      {" "}
