          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${ticket.status === "open" ? "bg-red-100 text-red-700" : ticket.status === "in_progress" ? "bg-amber-100 text-amber-700" : "bg-emerald-100 text-emerald-700"}`}
                >
                  {" "}
          ...
          <div className="space-y-4 mb-6">
            ...
            {messages.map((message) => (
              ...
              >
                {" "}
                <div
                  className={`max-w-[70%] rounded-lg p-4 ${message.sender_type === "landlord" ? "bg-primary-blue text-white" : "bg-gray-50 text-dark"}`}
                >
                  {" "}
