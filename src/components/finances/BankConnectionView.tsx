    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm text-blue-900">
          Importierte Transaktionen werden automatisch auf Duplikate geprueft.
          Bereits importierte Buchungen werden uebersprungen. Ihre Daten werden
          sicher verarbeitet und nie an Dritte weitergegeben.
        </p>
      </div>
    </div>
  );
