    ...
    return (
      <div className="relative group cursor-not-allowed">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-white/95 backdrop-blur rounded p-4 transform group-transition-all" style={{ border: '2px solid #d97706' }}>
  ...
  return (
    <div className="rounded-lg p-8 text-center" style={{ backgroundColor: '#eff4fe' }}>
      ...
      <p className="text-gray-400 mb-6 max-w-md mx-auto">
        Diese Funktion ist nur im Pro-Plan verfügbar. Upgraden Sie jetzt und
        erhalten Sie Zugriff auf alle erweiterten Features.
      </p>
