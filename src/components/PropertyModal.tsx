  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = {
        ...
        user_id: user.id,
        size_sqm: formData.property_type === 'parking' ? null : (formData.size_sqm || null),
        rooms: formData.property_type === 'parking' ? null : (formData.rooms || null),
        parking_spot_number: formData.property_type === 'parking' ? formData.parking_spot_number || null : null,
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, purchase_price: parseNumberInput(e.target.value) })}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, current_value: parseNumberInput(e.target.value) })}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, size_sqm: parseNumberInput(e.target.value) })}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, rooms: parseNumberInput(e.target.value) })}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
