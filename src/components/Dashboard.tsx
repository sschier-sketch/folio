...
import { Building2, Users, MessageSquare, LogOut, Home, Wallet, ChevronDown, User, TrendingUp, Gift, CreditCard, UserCog, MessageCircle, Lightbulb, Languages, CheckCircle, X, Menu, Shield } from 'lucide-react';
...
type View = 'home' | 'properties' | 'tenants' | 'tickets' | 'payments' | 'financial' | 'settings-profile' | 'settings-users' | 'settings-billing' | 'feedback' | 'referral';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-emerald-700 text-sm">
                  {language === 'de' ? 'Ihr Abonnement wurde erfolgreich aktiviert.' : 'Your subscription has been activated successfully.'}
                </p>
              </div>
            </div>
            <button
        ...
        <div className="flex gap-6 items-start">
          ...
          <main className="flex-1 min-w-0">
            ...
            {currentView === 'settings-profile' && <SettingsView activeTab="profile" />}
            {currentView === 'settings-users' && <SettingsView activeTab="users" />}
            {currentView === 'settings-billing' && <SettingsView activeTab="billing" />}
