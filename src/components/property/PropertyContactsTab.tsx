...
import { Users, Plus, Trash2, Edit2, Phone, Mail, Lock, UserCog } from "lucide-react";
      ...
      <div className="bg-white rounded-lg p-8">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Die Kontaktverwaltung für Immobilien ist im Pro-Tarif verfügbar. Upgrade jetzt für:
          </p>
          <div className="text-left space-y-2 mb-6">
            <div className="flex items-start gap-2">
              <Users className="w-5 h-5 text-primary-blue mt-0.5" />
              <span className="text-sm text-gray-600">Hausmeister-Kontakte zentral verwalten</span>
            </div>
            <div className="flex items-start gap-2">
              <Users className="w-5 h-5 text-primary-blue mt-0.5" />
              <span className="text-sm text-gray-600">Dienstleister und Handwerker hinterlegen</span>
            </div>
            <div className="flex items-start gap-2">
              <Users className="w-5 h-5 text-primary-blue mt-0.5" />
              <span className="text-sm text-gray-600">Eigentümer-Daten bei Verwaltung</span>
            </div>
            <div className="flex items-start gap-2">
              <Users className="w-5 h-5 text-primary-blue mt-0.5" />
