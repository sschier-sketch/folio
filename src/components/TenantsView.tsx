  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        >
          {" "}
          <Plus className="w-5 h-5" /> Mietverhältnis hinzufügen{" "}
        </button>{" "}
      </div>{" "}
      {contracts.length === 0 ? (
        <div className="bg-white rounded shadow-sm p-12 text-center">
          ...
          >
            {" "}
            <Plus className="w-5 h-5" /> Erstes Mietverhältnis hinzufügen{" "}
          </button>{" "}
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {contracts.map((contract) => (
            <div
              key={contract.id}
              className="bg-white rounded shadow-sm overflow-hidden hover:transition-shadow"
            >
              {" "}
              <div className="p-6">
                {" "}
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t ">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-dark">
                      {formatCurrency(contract.total_rent)}
                    </div>{" "}
                  </div>{" "}
                  <div>
                    {" "}
                    ...
                    <div className="text-sm text-dark">
                      {" "}
                      {new Date(contract.contract_start).toLocaleDateString(
                        "de-DE",
                      )}{" "}
                    </div>{" "}
                  </div>{" "}
