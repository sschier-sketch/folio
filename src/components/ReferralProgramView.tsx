    ...
    <div>
          ...
          <div className="bg-white/20 backdrop-blur rounded p-6 mb-6">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1">
                {" "}
                <p className="text-primary-blue/20 text-sm mb-2">
                  Ihr Empfehlungscode:
                </p>{" "}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  {" "}
                  Sobald Ihr Freund aktiv wird, erhalten Sie beide Ihre
                  Belohnung.{" "}
                </p>{" "}
              </div>{" "}
            </div>{" "}
        ...
        <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-6 text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/20 backdrop-blur rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-center gap-2">
                  {" "}
                  <div className="w-1.5 h-1.5 bg-white rounded-full"></div> 1
                  Monat Premium kostenlos{" "}
                </li>{" "}
                <li className="flex items-center gap-2">
                  {" "}
            ...
            <div className="bg-white/20 backdrop-blur rounded-lg p-4">
              {" "}
              <h4 className="font-semibold mb-2">
                Ihre Freunde erhalten:
              </h4>{" "}
              <ul className="space-y-2 text-sm">
                {" "}
                <li className="flex items-center gap-2">
                  {" "}
                  <div className="w-1.5 h-1.5 bg-white rounded-full"></div> 20%
      ...
      <div className="mt-6 bg-primary-blue/5 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-900">
          {" "}
          <span className="font-semibold">Hinweis:</span> Das
          Empfehlungsprogramm befindet sich derzeit in der Beta-Phase. Die
          finalen Belohnungen und Konditionen werden vor dem offiziellen Launch
          bekanntgegeben.{" "}
        </p>{" "}
      </div>{" "}
    </div>
