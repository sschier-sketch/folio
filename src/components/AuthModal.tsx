        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              {!isLogin && (
                <p className="mt-1 text-xs text-gray-300">Mindestens 6 Zeichen</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-4 py-3 bg-primary-blue text-white rounded-lg font-semibold hover:bg-primary-blue transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
