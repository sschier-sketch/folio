...
export default function Features() {
  ...
  const features = [
    {
      ...
      benefit:
        language === "de" ? "70% weniger Zeitaufwand" : "70% less time spent",
      color: "blue",
    ...
    },
    {
      ...
      benefit:
        language === "de"
          ? "99% Pünktlichkeit bei Zahlungen"
          : "99% payment punctuality",
      color: "amber",
    ...
    },
    {
      ...
      benefit:
        language === "de" ? "Keine verpassten Fristen" : "No missed deadlines",
      color: "purple",
    ...
    },
    {
      ...
      benefit:
        language === "de" ? "10x bessere Einblicke" : "10x better insights",
      color: "indigo",
  ...
  const journeySteps = [
    ...
    },
    {
      ...
      description:
        language === "de"
          ? "Laden Sie Ihren ersten Mieter ein"
    ...
    },
    {
      ...
      description:
        language === "de"
          ? "Schalten Sie alle Features frei"
          : "Unlock all features",
      reward: "+500 XP + Badge",
    },
  ];
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-md p-8 border-2 transition-all duration-300 cursor-pointer ${isHovered ? "border-blue-500 transform -translate-y-2" : "border-transparent hover:"}`}
                >
                  {" "}
                  <div
                    className={`w-16 h-16 rounded flex items-center justify-center mb-4 transition-transform duration-300 ${isHovered ? "scale-110" : "scale-100"} bg-${feature.color}-100`}
                  >
                    {" "}
                    <Icon
            ...
            <div className="relative">
              ...
              <div className="text-center mb-12">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white font-medium mb-4">
                  ...
                  {language === "de"
                    ? "Ihre Reise zur perfekten Verwaltung"
                    : "Your Journey to Perfect Management"}{" "}
                </div>{" "}
                ...
                {journeySteps.map((step, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`bg-white/10 backdrop-blur-sm rounded-md p-6 cursor-pointer transition-all duration-300 ${isCompleted ? "bg-emerald-500/20 border-2 border-emerald-400" : "hover:bg-white/20 border-2 border-transparent"}`}
                    >
                      {" "}
                      <div className="relative">
                        {" "}
                        <div
                          className={`w-12 h-12 rounded flex items-center justify-center mb-4 transition-all duration-300 ${isCompleted ? "bg-emerald-500" : "bg-white/20"}`}
                        >
                          {" "}
                          {isCompleted ? (
                      ...
                      <p className="text-primary-blue/20 text-sm">
                        {step.description}
                      </p>{" "}
                    </div>
                  );
