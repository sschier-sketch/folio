...
import {
  MessageSquare, Clock, CheckCircle2, Zap, Users, Shield,
  Heart, Star, Award, Trophy, TrendingUp, Sparkles, Mail,
  Phone, Video, FileText, Search, HelpCircle, Book, Headphones, Bell
} from 'lucide-react';
  ...
  const achievements = [
    {
      ...
      description: language === 'de' ? 'Erstes Ticket gelöst' : 'First ticket resolved',
      unlocked: ticketsResolved >= 1
    },
    {
      icon: Award,
      title: language === 'de' ? 'Support-Profi' : 'Support Pro',
      description: language === 'de' ? '5 Tickets gelöst' : '5 tickets resolved',
      unlocked: ticketsResolved >= 5
    },
    {
      icon: Star,
      title: language === 'de' ? 'Power-User' : 'Power User',
      description: language === 'de' ? '10 Tickets gelöst' : '10 tickets resolved',
