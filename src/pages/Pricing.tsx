...
import {
  Check, X, Zap, Sparkles, TrendingUp, Award, Gift,
  Crown, Rocket, Star, Users, Building2, Shield, Heart
} from 'lucide-react';
...
export default function Pricing() {
  ...
  const plans = [
    {
      ...
      badge: null,
      features: [
        { text: language === 'de' ? 'Bis zu 3 Immobilien' : 'Up to 3 properties', included: true },
        { text: language === 'de' ? 'Unbegrenzt Mieter' : 'Unlimited tenants', included: true },
        { text: language === 'de' ? 'Basic Finanzübersicht' : 'Basic financial overview', included: true },
        { text: language === 'de' ? 'Ticketsystem' : 'Ticket system', included: true },
        { text: language === 'de' ? 'Mieterportal' : 'Tenant portal', included: true },
        { text: language === 'de' ? 'E-Mail Support' : 'Email support', included: true },
        { text: language === 'de' ? 'Erweiterte Analysen' : 'Advanced analytics', included: false },
        { text: language === 'de' ? 'Prioritäts-Support' : 'Priority support', included: false },
        { text: language === 'de' ? 'API-Zugang' : 'API access', included: false },
      ],
      xp: '+100 XP',
    ...
    },
    {
      ...
      features: [
        { text: language === 'de' ? 'Bis zu 20 Immobilien' : 'Up to 20 properties', included: true },
        { text: language === 'de' ? 'Unbegrenzt Mieter' : 'Unlimited tenants', included: true },
        { text: language === 'de' ? 'Erweiterte Finanzanalysen' : 'Advanced financial analytics', included: true },
        { text: language === 'de' ? 'Prioritäts-Ticketsystem' : 'Priority ticket system', included: true },
        { text: language === 'de' ? 'Premium Mieterportal' : 'Premium tenant portal', included: true },
        { text: language === 'de' ? 'Prioritäts-Support (24h)' : 'Priority support (24h)', included: true },
        { text: language === 'de' ? 'Detaillierte Reports & Statistiken' : 'Detailed reports & statistics', included: true },
        { text: language === 'de' ? 'Automatische Erinnerungen' : 'Automatic reminders', included: true },
        { text: language === 'de' ? 'Export-Funktionen' : 'Export functions', included: true },
        { text: language === 'de' ? 'API-Zugang' : 'API access', included: false },
      ],
      xp: '+500 XP',
    ...
    },
    {
      ...
      features: [
        { text: language === 'de' ? 'Unbegrenzt Immobilien' : 'Unlimited properties', included: true },
        { text: language === 'de' ? 'Unbegrenzt Mieter' : 'Unlimited tenants', included: true },
        { text: language === 'de' ? 'Premium Finanzanalysen' : 'Premium financial analytics', included: true },
        { text: language === 'de' ? 'Enterprise Ticketsystem' : 'Enterprise ticket system', included: true },
        { text: language === 'de' ? 'White-Label Mieterportal' : 'White-label tenant portal', included: true },
        { text: language === 'de' ? 'VIP Support (2h Reaktionszeit)' : 'VIP support (2h response)', included: true },
        { text: language === 'de' ? 'Individuelle Reports' : 'Custom reports', included: true },
        { text: language === 'de' ? 'KI-gestützte Einblicke' : 'AI-powered insights', included: true },
        { text: language === 'de' ? 'Voller API-Zugang' : 'Full API access', included: true },
        { text: language === 'de' ? 'Dedizierter Account Manager' : 'Dedicated account manager', included: true },
      ],
      xp: '+1000 XP',
  ...
  const getPrice = (plan: typeof plans[0]) => {
    if (plan.monthlyPrice === 0) return language === 'de' ? 'Kostenlos' : 'Free';
            ...
            <div className="relative">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white font-medium mb-4">
                  ...
                  {language === 'de' ? 'Exklusive Boni' : 'Exclusive Bonuses'}
                </div>
