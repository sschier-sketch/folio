...
const translations = {
  de: {
    ...
    'settings.feedback.description': 'Teilen Sie uns Ihre Ideen und Verbesserungsvorschläge mit',
    'settings.feedback.idea': 'Ihre Idee',
    'settings.feedback.idea.placeholder': 'Beschreiben Sie Ihre Idee oder Ihren Verbesserungsvorschlag...',
    ...
    'feedback.description': 'Teilen Sie Ihre Ideen oder stimmen Sie über bestehende Vorschläge ab',
    ...
    'dashboard.quickstart.description': 'Beginnen Sie mit der Verwaltung Ihrer Immobilien, indem Sie Ihre erste Immobilie hinzufügen.',
    ...
    'dashboard.portal.description': 'Teilen Sie diesen Link mit Ihren Mietern, damit diese Tickets erstellen und den Status ihrer Anfragen verfolgen können.',
    ...
    'properties.empty.description': 'Fügen Sie Ihre erste Immobilie hinzu, um mit der Verwaltung zu beginnen.',
    'properties.add.first': 'Erste Immobilie hinzufügen',
    'properties.rooms': 'Zimmer',
    'properties.details': 'Details ansehen',
    'properties.delete.confirm': 'Möchten Sie diese Immobilie wirklich löschen?',
    // Property Details
    ...
    'property.loans.delete.confirm': 'Möchten Sie diesen Kredit wirklich löschen?',
    ...
    'property.yield.gross.formula': 'Formel: (Jahresmiete ÷ Aktueller Wert) × 100',
    ...
    'property.yield.net.formula': 'Formel: (Netto-Jahreseinkommen ÷ Aktueller Wert) × 100',
    ...
    'tenants.empty.description': 'Fügen Sie Ihr erstes Mietverhältnis hinzu, um mit der Verwaltung zu beginnen.',
    ...
    'payments.empty': 'Keine Mieteingänge gefunden. Mieteingänge werden automatisch generiert, wenn Sie Mietverträge anlegen.',
    ...
    'tickets.description': 'Verwalten Sie Anfragen und Nachrichten Ihrer Mieter',
    ...
    'tickets.empty.all': 'Erstellen Sie Ihr erstes Ticket oder warten Sie auf Anfragen von Mietern.',
    ...
    'financial.projection.disclaimer': 'Diese Prognose basiert auf den aktuellen Daten und den eingestellten jährlichen Steigerungsraten. Tatsächliche Ergebnisse können aufgrund von Marktveränderungen, Leerständen, Sonderausgaben und anderen Faktoren abweichen.',
    // Property Modal
    ...
    'modal.loan.principal.info': 'Tilgungsanteil der monatlichen Rate (Rate - Zinsen)',
  ...
  en: {
    ...
    'nav.tickets': 'Tickets',
    'nav.financial': 'Financial Analysis',
    'nav.account': 'Account',
    ...
    'dashboard.quickstart.description': 'Start managing your properties by adding your first property.',
    ...
    'dashboard.portal.description': 'Share this link with your tenants so they can create tickets and track the status of their requests.',
    ...
    'properties.empty.description': 'Add your first property to start managing.',
    ...
    'property.yield.gross.formula': 'Formula: (Annual Rent ÷ Current Value) × 100',
    ...
    'property.yield.net.formula': 'Formula: (Net Annual Income ÷ Current Value) × 100',
    ...
    'tenants.empty.description': 'Add your first rental contract to start managing.',
    ...
    'payments.empty': 'No rent payments found. Rent payments are automatically generated when you create lease agreements.',
    ...
    'tickets.empty.all': 'Create your first ticket or wait for requests from tenants.',
    ...
    'financial.projection.disclaimer': 'This projection is based on current data and the set annual increase rates. Actual results may vary due to market changes, vacancies, extraordinary expenses, and other factors.',
    // Property Modal
    ...
    'modal.loan.principal.info': 'Principal portion of monthly payment (Payment - Interest)',
