...
const translations = {
  de: {
    ...
    "settings.users.owner": "Eigentümer",
    ...
    "property.yield.gross.calculation": "Berechnung Brutto-Mietrendite:",
    ...
    "property.yield.gross.value": "Kaufpreis",
    "property.yield.net.calculation": "Berechnung Netto-Mietrendite:",
    "property.yield.net.formula":
      "Formel: (Netto-Jahreseinkommen ÷ Kaufpreis) × 100",
    ...
    "payments.status.outstanding": "Offen",
  ...
  en: {
    ...
    "nav.mieterportal": "Tenant Portal",
    ...
    "referral.description": "Refer rentably and earn {rate}% commission",
    ...
    "property.yield.gross.calculation": "Gross Rental Yield Calculation:",
    "property.yield.gross.formula":
    ...
    "property.yield.gross.value": "Purchase Price",
    "property.yield.net.calculation": "Net Rental Yield Calculation:",
    "property.yield.net.formula":
      "Formula: (Net Annual Income ÷ Purchase Price) × 100",
