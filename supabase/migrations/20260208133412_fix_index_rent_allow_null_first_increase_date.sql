/*
  # Fix index rent calculation to work without index_first_increase_date

  1. Changes
    - Removed the requirement for index_first_increase_date to be NOT NULL
    - When index_first_increase_date is NULL, defaults to contract_start + 12 months
    - This ensures contracts with rent_increase_type = 'index' are always found

  2. Notes
    - Previously, contracts without index_first_increase_date were silently excluded
    - The 12-month default aligns with German law (minimum interval for index rent increases)
    - All other logic (12-month minimum interval, minimum increase threshold) remains unchanged
*/
