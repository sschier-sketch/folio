/*
  # Reduziere Mindesterhöhung für Indexmiete auf 0,01%

  ## Problem
  Die Funktion prüft nur auf Erhöhungen >= 1%, aber rechtlich sind auch kleinere Erhöhungen zulässig.
  "Kleinvieh macht auch Mist" - jede Erhöhung ab 0,01% sollte berücksichtigt werden.

  ## Lösung
  - Ändere die Mindesterhöhung von 1% (0.01) auf 0,01% (0.0001)
  - Dies ermöglicht auch kleinste Indexerhöhungen zu erfassen

  ## Änderungen
  1. Reduziere Mindest-Schwellenwert in der Funktion
*/
...
BEGIN
  ...
  LOOP
    ...
    IF v_months_since_last >= 12 THEN
      ...
      -- Nur speichern wenn Änderung mindestens 0,01% beträgt (statt 1%)
...
'Führt automatische Indexmieten-Berechnungen für alle Verträge mit rent_increase_type = index durch. Mindesterhöhung: 0,01%.';