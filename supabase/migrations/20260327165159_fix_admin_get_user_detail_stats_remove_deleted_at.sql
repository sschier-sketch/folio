/*
  # Fix admin_get_user_detail_stats RPC

  Removes reference to non-existent `deleted_at` column on rental_contracts.
  Counts all rental contracts for the user instead.
*/
