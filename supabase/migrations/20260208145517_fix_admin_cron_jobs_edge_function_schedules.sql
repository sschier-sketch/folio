/*
  # Fix edge function schedule labels in admin_get_cron_jobs

  1. Changes
    - Update CASE statement to include all 6 edge function job names
    - Use consistent job names matching what edge functions log to cron_runs
    - Add create-rent-increase-reminders and run-index-rent-calculations
*/
